...
public enum TranslatableLine {
    ...
    SHOP_BOUGHT_ON(".Messages.Shop.Bought-On"),
    ...
    public String getSingle() {
        return Text.color(MSWConfig.file().getString("Config.Languages." + this.configPath));
    }

    public String getInLanguage(String l) {
        return Text.color(MysticosSkywarsAPI.getInstance().getLanguageManagerAPI().getLanguage(l).getString(this.configPath));
    }

    public String get(MSWPlayer player) {
        return get(player, false);
    }

    public String get(MSWPlayer player, boolean prefix) {
        return Text.color((prefix ? MysticosSkywarsAPI.getInstance().getLanguageManagerAPI().getPrefix() : "") + getInLanguage(player.getLanguage()));
    }
    ...
    public String getDefault() {
        ...
        return getInLanguage(configuredLanguage != null ? configuredLanguage : MysticosSkywarsAPI.getInstance().getLanguageManagerAPI().getDefaultLanguage());
    }

    public void sendDefault(CommandSender p, boolean prefix) {
        p.sendMessage(prefix ? MysticosSkywarsAPI.getInstance().getLanguageManagerAPI().getPrefix() + getDefault() : getDefault());
    }

    public void sendSingle(MSWPlayer p) {
        if (p.getPlayer() != null) {
            p.sendMessage(getSingle());
        }
    }

    public void send(MSWPlayer p, boolean prefix) {
        if (p.getPlayer() != null) {

package joserodpt.mysticosskywars.api.nms;
...
public class NMS114R1tov116R3 implements MSWnms {
    ...
    public void playChestAnimation(Block block, boolean open) {
        ...
        try {
            ...
            MysticosSkywarsAPI.getInstance().getLogger().severe("Error while executing chest animation nms.");
            MysticosSkywarsAPI.getInstance().getLogger().severe(ex.toString());
        }
    }
    ...
    public String getItemName(Material mat) {
        try {
            ...
            MysticosSkywarsAPI.getInstance().getLogger().severe("Error while executing getItemName nms.");
            MysticosSkywarsAPI.getInstance().getLogger().severe(ex.toString());
            return "-";
        }
    }

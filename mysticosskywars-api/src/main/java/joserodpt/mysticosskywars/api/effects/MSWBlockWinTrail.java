...
public class MSWBlockWinTrail implements MSWTrail {
    ...
    public MSWBlockWinTrail(MSWPlayer gp, int seconds) {
    ...
    public MSWBlockWinTrail(MSWPlayer gp, int seconds, Material b) {
        this.executionTime = seconds;
        this.p = gp;
    ...
    public void startTask() {
        this.task = Bukkit.getServer().getScheduler().runTaskTimer(MysticosSkywarsAPI.getInstance().getPlugin(), () -> {
            ...
            switch (bwp) {
                case SINGLE:
                    ...
                    fbs.setMetadata("trailBlock", new FixedMetadataValue(MysticosSkywarsAPI.getInstance().getPlugin(), 1));
                    break;
                case RANDOM:
                    Material mr = this.randBlocks.get(MysticosSkywarsAPI.getInstance().getRandom().nextInt(this.randBlocks.size()));
                    ...
                    fbr.setMetadata("trailBlock", new FixedMetadataValue(MysticosSkywarsAPI.getInstance().getPlugin(), 1));
                    break;
                default:
                    break;
            }
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(MysticosSkywarsAPI.getInstance().getPlugin(), this::cancelTask, this.executionTime * 20L);
    }

...
import joserodpt.mysticosskywars.api.managers.holograms.support.DHHologram;
import joserodpt.mysticosskywars.api.managers.holograms.support.HDHologram;
import joserodpt.mysticosskywars.api.managers.holograms.support.NoHologram;
import org.bukkit.Location;

public interface MSWHologram {
    enum HType {

...
public class MSWSpectatorShopItem extends MSWBuyableItem {

    public MSWSpectatorShopItem(String configKey, String displayName, Material material, Double price, String permission) {

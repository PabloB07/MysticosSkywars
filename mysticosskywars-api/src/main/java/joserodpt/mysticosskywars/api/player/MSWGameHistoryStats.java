...
public class MSWGameHistoryStats {
    ...
    public MSWGameHistoryStats(Collection<PlayerGameHistoryRow> logs) {
    ...
    public ItemStack getItem(MSWPlayer mswp) {
        return Itens.createItem(Material.BOOKSHELF, 1, TranslatableLine.STATISTIC_NAME.get(mswp), getLore(mswp));
    }

    private List<String> getLore(MSWPlayer mswp) {
        List<String> list = TranslatableList.STATISTIC_GAMES_LIST.get(mswp);

...
public class MSWGameLog {

    private String map;
    private int players, seconds, kills;
    private boolean ranked, win;
    private MSWMap.GameMode gameMode;
    private String dayandtime;

    private boolean dummy = false;

    public MSWGameLog(String map, String gameMode, boolean ranked, int players, int kills, boolean win, int seconds, String dayandtime) {
        this.map = map;
        this.gameMode = MSWMap.GameMode.valueOf(gameMode);
        this.ranked = ranked;

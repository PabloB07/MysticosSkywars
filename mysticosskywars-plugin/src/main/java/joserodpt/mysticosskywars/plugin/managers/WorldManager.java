...
public class WorldManager extends WorldManagerAPI {
    ...
    public WorldManager(MysticosSkywarsAPI rs) {
        this.rs = rs;
    }
    ...
    public void deleteWorld(String name, boolean removeFile) {
        ...
        if (removeFile) {
            ...
            try {
                ...
                MysticosSkywarsAPI.getInstance().getLogger().severe("Error trying to delete World " + name);
                MysticosSkywarsAPI.getInstance().getLogger().severe(e.getMessage());
            }
        }
    }
    ...
    public void deleteDirectory(final File directory) throws IOException {
        ...
        if (!directory.delete()) {
            MysticosSkywarsAPI.getInstance().getLogger().warning("Unable to delete directory " + directory);
        }
    }
    ...
    @Override
    public World duplicateWorld(MSWWorld original, String newName) {
        ...
        if (sourceMap.exists()) {
            ...
            try {
                ...
                MysticosSkywarsAPI.getInstance().getLogger().severe("Failed to copy schematic: + " + original.getName() + ".schem");
                MysticosSkywarsAPI.getInstance().getLogger().severe(e.getMessage());
            }
        }
